...
if (CLIENT) then
	SWEP.PrintName 		= "Tri-beam Laser Rifle"
	SWEP.Slot 			= 3
	SWEP.SlotPos 		= 1
	SWEP.IconLetter 		= " "
...
SWEP.Primary.Sound 		= Sound("weapon_tribeamlaser.Single")
...
SWEP.IronSightsPos = Vector (-5.3942, 0, -0.0748)
